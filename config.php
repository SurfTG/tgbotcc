...
// =======================================================
define('DB_HOST', 'bfzusbrvxvtnqredkqt1-mysql.services.clever-cloud.com');           // Ejemplo: 'localhost' o 'mysql.example.com'
define('DB_USERNAME', 'uxufb9jti8i0tj6w');   // Tu usuario de base de datos
define('DB_PASSWORD', 'VgNbZiCuWmZwYLCGGF9Z');   // Tu contraseña de base de datos
define('DB_NAME', 'bfzusbrvxvtnqredkqt1');           // Nombre de tu base de datos

// =======================================================
// CONFIGURACIÓN DEL BOT DE TELEGRAM
// =======================================================
$botToken = "8444413896:AAEvJH53X2HyE4_69WAy4U6WPQeBc1l2LuI";                 // Token de tu bot de Telegram (@BotFather)
$Mi_Id = "1920330258";                  // Tu ID de usuario de Telegram
